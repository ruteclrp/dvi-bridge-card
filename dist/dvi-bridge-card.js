class DviBridgeCard extends HTMLElement {
    ...
    this.innerHTML = `
      <ha-card header="DVI LV12 Compact varmepumpe">
        <div id="container" style="position:relative;">
          <img src="/hacsfiles/dvi-bridge-card/www/images/dvi.gif?v=2" style="width:100%;" />
        </div>
      </ha-card>
    `;
  }
  ...
  _render() {
    ...
    if (cvPump?.state === "on") {
      this._addImage(container, "/hacsfiles/dvi-bridge-card/www/images/CV_on.gif", "55%", "78%", "21%");
      this._addImage(container, "/hacsfiles/dvi-bridge-card/www/images/CVflow_on.gif", "76.9%", "64.7%", "14.2%");
    ...
    if (compressor?.state === "on") {
      this._addImage(container, "/hacsfiles/dvi-bridge-card/www/images/HP_on.gif", "25.6%", "1.4%", "33.9%");
      this._addImage(container, "/hacsfiles/dvi-bridge-card/www/images/COMP_on.gif", "25.6%", "35.4%", "21.3%");
